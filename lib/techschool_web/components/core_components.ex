defmodule TechschoolWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(TechschoolWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(TechschoolWeb.Gettext, "errors", msg, opts)
    end
  end
